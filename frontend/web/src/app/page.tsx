...
export default function OnboardingPage() {
  ...
  const toggleCondition = (id: string) => {
    const updatedConditions = profile.conditions.includes(id)
      ? profile.conditions.filter((c) => c !== id)
      : [...profile.conditions, id];

    updateProfile({ ...profile, conditions: updatedConditions });
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 p-8">
      ...
      <main className="max-w-4xl mx-auto space-y-8">
        {/* Section 1 & 2: Health Profile & Safety Evaluator */}
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateProfile({ ...profile, weight_kg: Number(e.target.value) })}
                    className="w-full mt-1 border rounded-md p-2 text-sm"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateProfile({ ...profile, height_cm: Number(e.target.value) })}
                    className="w-full mt-1 border rounded-md p-2 text-sm"
                  />
                </div>
              </div>
        ...
        {/* Section 3: Recommended Meal Plan & Dynamic Grocery Cart */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-lg font-bold text-slate-800 mb-4">Recommended Meal Plan</h2>
            <div className="space-y-4">
              <MealCard
                ...
                protein={38}
                fats={18}
                warnings={profile.conditions.includes('pregnancy') ? ['Ensure salmon is fully cooked'] : []}
              />
              <MealCard
